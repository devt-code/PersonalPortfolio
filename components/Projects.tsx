  ...
  const projects = [
    {
      ...
      description: 'A full-stack learning management system with role-based access control, course management, and secure authentication. Hosted on Vercel and Render.',
    ...
    },
    {
      ...
      description: 'A Java-based virtual calendar system supporting multiple calendars with independent timezones, recurring events, and CSV/iCal export functionality.',
    ...
    },
    {
      ...
      description: 'ML-powered system for predicting lung and heart diseases with 94% accuracy using CNNs for X-ray classification and Logistic Regression for risk prediction.',
    ...
    <section id="projects" className="section-container bg-white">
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          A collection of projects I've built, showcasing my skills and passion for creating
